...
pix_change_cout_gate_H = 20;pix_change_cout_gate_L = 10;pix_gate_H = 20;pix_gate_L = 18;pix_gate = 20;%other_video
% pix_change_cout_gate_H = 20;pix_change_cout_gate_L = 8;pix_gate_H = 20;pix_gate_L = 18;pix_gate = 20; %11_video
pre_frame_cout = 0;
...
level_1_row = row_node_0/2; level_2_row = level_1_row/2; level_3_row = level_2_row/2; level_4_row = level_3_row/2;level_5_row = level_4_row/2;
level_1_col = col_node_0/2; level_2_col = level_1_col/2; level_3_col = level_2_col/2; level_4_col = level_3_col/2;level_5_col = level_4_col/2;

ramdom_cout = 12;temp_all = 0;
ramdom_obj_num = 2;
while(ramdom_cout <= 13)
...
% xlswrite('D:\document\Thorium\plan_b_new_matlab_devide\output\input_all_4.xlsx',write_level_3_output,num2str(ramdom_obj_num),'A1');
xlswrite('.\output\input5_all.xlsx',write_level_0_output,num2str(ramdom_obj_num),'A1');
xlswrite('.\output\input5_all_4.xlsx',write_level_4_output,num2str(ramdom_obj_num),'A1');
